CH = {
 'n': 9,
 't': 'Sources of Government Revenue',
 'brief': 'Tax and non-tax revenue, the Federation Account and the principles on which it is '
          'shared, the derivation principle, the distribution of value added tax, and internally '
          'generated revenue at state and local level.',
 'outcomes': [
   'Distinguish tax from non-tax revenue and give examples of each',
   'Distinguish statutory allocation from internally generated revenue',
   'Explain the operation of the Federation Account',
   'State the vertical and horizontal principles of revenue allocation',
   'Explain the 13% derivation principle and the distribution of VAT',
   'Suggest ways of improving internally generated revenue',
 ],
 'secs': [
  {'n': '9.1', 't': 'Classification of government revenue', 'b': [
    {'h4': 'Tax revenue'},
    {'p': 'A **tax** is a compulsory levy imposed by government on individuals and '
          'organisations, for which no direct or proportionate benefit is received in return.'},
    {'table': {'align': 'lll', 'head': ['Tax', 'Collected by', 'Basis'], 'rows': [
      ['**Petroleum Profits Tax / Hydrocarbon Tax**', 'FIRS',
       'Profits of companies engaged in petroleum operations'],
      ['**Companies Income Tax**', 'FIRS', 'Profits of registered companies'],
      ['**Personal Income Tax**', 'State Boards of Internal Revenue (FIRS for the Armed '
       'Forces, police, Foreign Affairs and FCT residents)',
       'Income of individuals, by residence'],
      ['**Value Added Tax**', 'FIRS', 'Consumption of goods and services'],
      ['**Customs and Excise Duties**', 'Nigeria Customs Service',
       'Imports, exports and excisable goods manufactured locally'],
      ['**Capital Gains Tax**', 'FIRS / State Boards', 'Gains on disposal of chargeable assets'],
      ['**Stamp Duties**', 'FIRS / State Boards', 'Instruments and certain transactions'],
      ['**Education Tax (TETFund levy)**', 'FIRS', 'Assessable profits of companies'],
    ]}},
    {'h4': 'Non-tax revenue'},
    {'ul': [
      '**Royalties** on crude oil, gas and solid minerals.',
      '**Licences and fees** — drivers\' licences, business premises registration, radio and '
      'television licences, court fees.',
      '**Fines and penalties** imposed by courts and regulators.',
      '**Earnings and sales** — proceeds of government commercial activities, hospital and '
      'school fees, sale of government publications and scrap.',
      '**Rent** on government property and land.',
      '**Interest and repayments** on loans granted by government.',
      '**Dividends and operating surpluses** from government investments and from scheduled '
      'corporations under the Fiscal Responsibility Act.',
      '**Grants and aid** from foreign governments and international agencies.',
      '**Borrowing** — internal (treasury bills, bonds) and external — which is a source of '
      '**financing** rather than revenue proper, since it must be repaid.',
    ]},
    {'warn': 'Borrowing is often listed by candidates as a source of revenue. It is more '
             'precisely a source of **financing**: it creates a liability and does not increase '
             'net assets. Saying so explicitly is worth a mark in a question on classification.'},
    {'h4': 'By tier of government'},
    {'table': {'align': 'll', 'head': ['Source', 'Nature'], 'rows': [
      ['**Statutory allocation**',
       'The share of the Federation Account distributed to a tier of government under the '
       'Allocation of Revenue Act'],
      ['**Internally generated revenue (IGR)**',
       'Revenue a state or local government raises within its own jurisdiction — personal '
       'income tax, licences, fees, fines, rates, rents, earnings'],
      ['**Value added tax allocation**',
       'The share of the VAT pool distributed to the tier'],
      ['**Grants**',
       'From a higher tier or from a donor, often for a specified purpose (matching grants '
       'for capital projects)'],
      ['**Excess crude / augmentation**',
       'Distributions from savings of revenue above the budget benchmark'],
    ]}},
  ]},

  {'n': '9.2', 't': 'The Federation Account', 'b': [
    {'p': 'Section 162(1) of the 1999 Constitution provides that the Federation shall maintain a '
          'special account called **the Federation Account** into which shall be paid all revenue '
          'collected by the Government of the Federation, with the exception of the proceeds of '
          'personal income tax of the personnel of the Armed Forces, the Nigeria Police Force, '
          'the Ministry of Foreign Affairs and residents of the Federal Capital Territory.'},
    {'h4': 'Operation'},
    {'ol': [
      'Revenue-collecting agencies — the Federal Inland Revenue Service, the Nigeria Customs '
      'Service, the Nigerian Upstream Petroleum Regulatory Commission and NNPC — pay '
      'collections into the Federation Account.',
      'First-line charges are deducted: the cost of collection of the collecting agencies, and '
      'certain other statutory deductions.',
      'The **Federation Account Allocation Committee (FAAC)** meets monthly, reviews the '
      'inflows, and determines the amount available for distribution.',
      'The balance is distributed among the three tiers on the **vertical** formula, and among '
      'the states and among the local governments on the **horizontal** formula.',
      'The Federal share is paid into the **Consolidated Revenue Fund**; each state\'s share '
      'into its own consolidated revenue fund; and the local government share into the **State '
      'Joint Local Government Account** for distribution to the councils.',
    ]},
    {'h4': 'Vertical allocation (sharing between tiers)'},
    {'table': {'align': 'lr', 'head': ['Tier', 'Share of the Federation Account'], 'rows': [
      ['Federal Government', '52.68%'],
      ['State Governments', '26.72%'],
      ['Local Governments', '20.60%'],
      ['Total', '100.00%'],
    ]}},
    {'p': 'These are the percentages in operation following the Supreme Court judgment of 2002 '
          'and the subsequent modification orders. The formula is subject to periodic review by '
          'the Revenue Mobilisation Allocation and Fiscal Commission (RMAFC), whose '
          'recommendations require an Act of the National Assembly.'},
    {'h4': 'Horizontal allocation (sharing among states, and among local governments)'},
    {'table': {'align': 'lr', 'head': ['Principle', 'Weight'], 'rows': [
      ['Equality of states', '40%'],
      ['Population', '30%'],
      ['Internal revenue generation effort', '10%'],
      ['Land mass and terrain', '10%'],
      ['Social development factor (education, health, water)', '10%'],
      ['Total', '100%'],
    ]}},
    {'key': 'The **derivation principle** operates separately and before the horizontal formula. '
            'Section 162(2) requires that not less than **13% of the revenue accruing to the '
            'Federation Account directly from any natural resource** be paid to the state from '
            'which it was derived, as a first charge. Only the balance goes into the pool shared '
            'on the formula above.'},
  ]},

  {'n': '9.3', 't': 'Value added tax', 'b': [
    {'p': 'VAT proceeds are not paid into the Federation Account but into a **separate VAT '
          'Pool Account**, and are distributed on a different formula.'},
    {'table': {'align': 'lr', 'head': ['Tier', 'Share of the VAT pool'], 'rows': [
      ['Federal Government', '15%'],
      ['State Governments', '50%'],
      ['Local Governments', '35%'],
      ['Total', '100%'],
    ]}},
    {'p': 'The state and local government shares are then distributed among them on the basis of '
          'equality (50%), population (30%) and derivation (20%).'},
    {'note': 'The distribution of VAT has been the subject of litigation between the Federal '
             'Government and several states, which have argued that consumption tax is a '
             'residual matter within the legislative competence of the states. Candidates need '
             'only know that the dispute exists and that the formula above is the one currently '
             'operated.'},
  ]},

  {'n': '9.4', 't': 'Internally generated revenue', 'b': [
    {'p': 'Heavy dependence on statutory allocation, and therefore on the oil price, is the '
          'principal structural weakness of state and local government finance in Nigeria. '
          'Improving internally generated revenue is a standard Section B question.'},
    {'h4': 'Problems of internally generated revenue'},
    {'ul': [
      'A **narrow revenue base**, with much economic activity in the informal sector and '
      'outside any register.',
      '**Poor records** — no reliable database of taxpayers, properties, vehicles or businesses.',
      '**Leakage and diversion**, where collections are received in cash by officials and never '
      'reach the treasury.',
      '**Multiple taxation** by overlapping authorities, which discourages compliance and '
      'drives businesses out of the formal sector.',
      '**Weak enforcement** and reluctance to prosecute defaulters, particularly where they are '
      'politically connected.',
      '**Public resistance**, arising from the perception that taxes are not translated into '
      'services.',
      '**Untrained and poorly motivated staff**, and inadequate revenue offices and equipment.',
    ]},
    {'h4': 'Ways of improving internally generated revenue'},
    {'ol': [
      '**Broaden the base** by identifying and registering informal-sector operators, '
      'presumptive taxation of small businesses, and enumeration of properties for tenement '
      'rating.',
      '**Automate collection** — electronic payment platforms, a single revenue account, and '
      'the elimination of cash handling by collectors. This is the single most effective '
      'measure, because it removes the opportunity rather than relying on integrity.',
      '**Build a taxpayer database** and integrate it with other registers — the corporate '
      'registry, land registry, vehicle registration and the national identity number.',
      '**Harmonise levies** to eliminate multiple taxation, publish an approved list of taxes '
      'and levies, and prohibit collection outside it.',
      '**Strengthen enforcement** with adequate legal powers, tax tribunals, and the publication '
      'of the names of persistent defaulters.',
      '**Train and motivate revenue staff**, with performance-based incentives tied to '
      'collection rather than to assessment.',
      '**Improve taxpayer education and service delivery**, since compliance rises when '
      'taxpayers can see what the money purchases.',
      '**Reform the revenue authority** into an autonomous, professionally managed board, as '
      'the states with the highest IGR have done.',
      '**Block leakages** through internal audit, revenue monitoring and reconciliation between '
 ...
 'formulas': [
  {'lb': 'Derivation (first charge)',
   'tex': '\\ge 13\\% \\times \\text{natural resource revenue}'},
  {'lb': 'Amount distributable',
   'tex': '\\text{Gross} - \\text{cost of collection} - \\text{derivation}'},
  {'lb': 'A state\'s statutory allocation',
   'tex': '\\text{Distributable} \\times 26.72\\% \\times \\text{state horizontal factor}'},
 ],
 'focus':
   'Two or three Section A marks every diet on the vertical formula, the 13% derivation '
   'principle, the VAT distribution, or the classification of a particular receipt. Section B '
   'commonly asks for the sources of revenue of a state or local government, or for ways of '
   'improving internally generated revenue. Learn the three vertical percentages and the five '
   'horizontal principles with their weights; they are asked directly.',
 'errors': [
   'Saying all revenue of the Federation goes into the Consolidated Revenue Fund; revenue '
   'collected by the Government of the Federation goes into the Federation Account, and only '
   'the Federal share reaches the CRF.',
   'Giving the derivation principle as 13% of the Federation Account; it is 13% of revenue from '
   'natural resources, and it is a first charge.',
   'Applying the Federation Account vertical formula to VAT; VAT has its own pool and its own '
   'formula.',
   'Listing borrowing as revenue without noting that it is financing and creates a liability.',
   'Confusing statutory allocation (from the Federation Account) with internally generated '
   'revenue (raised by the tier itself).',
 ],
 'quiz': {
  'mcq': [
   {'q': 'Under section 162(2) of the 1999 Constitution, the derivation principle provides that '
         'not less than what percentage of revenue from natural resources goes to the state of '
         'derivation?',
    'o': ['10%', '13%', '20%', '25%', '50%'],
    'a': 1,
   ...
   {'q': 'Value added tax proceeds are shared among the tiers of government in the ratio',
    'o': ['Federal 52.68%, States 26.72%, Local 20.60%',
          ...
          'Federal 50%, States 35%, Local 15%',
          'Federal 35%, States 50%, Local 15%',
          'Federal 20%, States 40%, Local 40%'],
    'a': 1,
   ...
   {'q': 'Personal income tax of members of the Armed Forces and residents of the Federal '
    ...
    'o': ['the State Boards of Internal Revenue', 'the Federal Inland Revenue Service',
          'the Nigeria Customs Service', 'the Accountant-General',
  ...
  'theory': [
   {'q': 'Many state and local governments in Nigeria depend heavily on statutory allocation '
         'from the Federation Account. (a) Distinguish between statutory allocation and '
         'internally generated revenue, and state five sources of internally generated revenue '
         'available to a state government. (b) Explain the problems that limit internally '
         'generated revenue in Nigeria. (c) Recommend measures by which a state government '
         'could improve its internally generated revenue.',
    'marks': 20,
    'a': [
      {'h4': '(a) The distinction'},
      {'p': '**Statutory allocation** is the share of the Federation Account distributed to a '
            'tier of government under section 162 of the Constitution and the Allocation of '
            'Revenue Act. It is received rather than earned: the state exerts no effort to '
            'obtain it and has no control over its size, which depends on federally collected '
            'revenue and therefore largely on the price and volume of crude oil.'},
      {'p': '**Internally generated revenue** is revenue a state raises within its own '
            'jurisdiction from its own tax and non-tax sources. It depends directly on the '
            'state\'s administrative effort, its economic base and the quality of its revenue '
            'machinery, and it is therefore both more stable and more within the state\'s '
            'control.'},
      {'p': '**Sources of internally generated revenue available to a state:**'},
      {'ol': [
        '**Personal income tax** on residents of the state, under the Pay As You Earn system '
        'and by direct assessment of the self-employed — normally the largest single source.',
        '**Road taxes and vehicle-related charges** — vehicle licences, drivers\' licences, '
        'number plates, roadworthiness certificates and haulage permits.',
        '**Business premises registration and renewal fees**, and development levies.',
        '**Fees and licences** — market and abattoir fees, liquor licences, court fees, '
        'registration of births, deaths and marriages, hospital and school fees.',
        '**Earnings and sales** from state commercial undertakings, and dividends from state '
        'investments.',
        '**Rent** on state-owned land and property, ground rent and certificate of occupancy '
        'charges.',
        '**Fines and penalties** imposed by state courts and regulatory agencies.',
        '**Capital gains tax and stamp duties** within the state\'s competence.',
      ]},
      {'h4': '(b) Problems limiting internally generated revenue'},
      {'ol': [
        '**A narrow and largely informal revenue base.** A very large proportion of economic '
        'activity takes place outside any register — traders, artisans, transporters, small '
        'landlords — and is neither assessed nor collected from.',
        '**Absence of reliable records.** Most states lack a complete database of taxpayers, '
        'properties, vehicles and businesses, so assessments cannot be raised systematically '
        'and defaulters cannot be identified.',
        '**Leakage and diversion.** Where collections are received in cash by individual '
        'officers, a proportion never reaches the treasury. Fake receipts and unauthorised '
        'collection points are common.',
        '**Multiple taxation.** Overlapping demands by state agencies, local governments and '
        'unauthorised bodies impose a heavy compliance burden, discourage formalisation and '
        'invite evasion.',
        '**Weak enforcement.** Legal powers are underused, prosecution of defaulters is rare, '
        'and revenue agencies are reluctant to pursue politically connected taxpayers.',
        '**Taxpayer resistance.** Where citizens see no relationship between the taxes they pay '
        'and the services they receive, compliance is treated as optional and evasion attracts '
        'no social disapproval.',
        '**Institutional weakness.** Revenue staff are frequently untrained, poorly paid and '
        'poorly equipped, and revenue administration is fragmented across ministries rather '
        'than concentrated in a professional authority.',
        '**Over-reliance on allocation.** Because the monthly allocation arrives whatever the '
        'state does, there has historically been little political incentive to undertake the '
        'unpopular work of taxing residents.',
      ]},
      {'h4': '(c) Recommended measures'},
      {'ol': [
        '**Automate assessment and collection.** Move all collections onto electronic platforms '
        'paying into a single state revenue account, and abolish cash handling by collectors. '
        'This is the most effective single measure available, because it removes the '
        'opportunity for diversion rather than relying on the honesty of individual officers.',
        '**Build and integrate a taxpayer database.** Enumerate residents, properties, vehicles '
        'and businesses, and link the register to the national identity number, the corporate '
        'registry, the land registry and utility records so that non-filers are identified '
        'automatically.',
        '**Broaden the base.** Bring the informal sector in through simplified presumptive '
        'taxation at modest rates, which is administratively cheap and establishes a compliance '
        'habit; and complete the enumeration and valuation of properties for tenement rating, '
        'which is a large and largely untapped source.',
        '**Harmonise and publish the approved list of taxes and levies**, prohibit collection '
        'outside it, and dismantle unauthorised roadblocks and collection points. Reducing '
        'multiple taxation raises revenue by encouraging formalisation.',
        '**Establish an autonomous, professionally managed state internal revenue service**, '
        'with its own board, power to recruit and remunerate competitively, and a defined '
        'percentage of collections for its running costs. The states with the highest IGR are '
        'those that have done this.',
        '**Strengthen enforcement.** Use the tax appeal machinery, prosecute persistent '
        'defaulters, publish their names, and apply the statutory sanctions consistently and '
        'without regard to political connection.',
        '**Train and motivate revenue staff**, with performance measured on amounts actually '
        'collected and reconciled rather than on assessments raised.',
        '**Improve taxpayer education and, above all, visible service delivery.** Compliance '
        'rises where citizens can see roads, schools and clinics attributable to the taxes they '
        'pay. Publishing what was collected and what it purchased is itself a revenue measure.',
        '**Institute internal audit and revenue monitoring**, reconciling assessments raised '
        'with amounts collected and banked, to block leakage.',
      ]},
      {'note': 'The underlying point, worth stating in a conclusion, is that internally '
               'generated revenue is not merely a fiscal matter. A government financed by its '
