  ...
  V.revision = function () {
    withRevision(function (rev) {
      ...
      A.h('<div class="wrap"><section class="shead" style="border:none">' +
        '<div class="code">Final Revision</div><h1>Every past question, most recently ' +
        'asked first</h1>' +
        '<p>All 24 diets\' MCQ, short-answer and Section B questions, grouped by subject, ' +
        'then by question type, near-duplicates across diets merged and ordered by the '  +
        'most recent diet each was asked in. Pick a subject.</p></section>' +
    ...
    withRevision(function (rev) {
      ...
      var kinds = [
        { key: 'mcq', label: 'Multiple choice', d: 'Every past MCQ, options and the ' +
          'examiner\'s own answer, most recently asked first.', n: d.mcq.length },
        { key: 'saq', label: 'Short answer', d: 'Fill-in-the-blank and one-line questions, ' +
          'with the official answer, grouped by topic — most-tested topics first, most ' +
          'recently asked within each topic.', n: d.saq.length },
        { key: 'essay', label: 'Essay (Section B)', d: 'Full Section B questions with the ' +
          'official worked solution, most recently asked first.', n: d.essay.length },
      ];
    ...
    withRevision(function (rev) {
      ...
      A.h('<div class="wrap"><section class="paperhead">' +
        ...
        '<p>' + list.length + (kind === 'saq' ?
          ...
          'recently asked question within each topic first.' :
          ' questions, most recently asked first.') +
